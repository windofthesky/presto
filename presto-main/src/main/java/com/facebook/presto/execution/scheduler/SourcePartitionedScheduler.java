        ...
        implements StageScheduler
{
        ...
        switch (state) {
            ...
            default:
                throw new IllegalStateException(
                        format("SourcePartitionedScheduler expeted to be in INITIALIZED or SPLITS_SCHEDULED state" +
                                " but is in [%s]", state));
        }
    }
    ...
    private ScheduleResult scheduleEmptySplit()
    {
        ...
        Set<RemoteTask> emptyTask = assignSplits(ImmutableMultimap.of(node, splitSource.getEmptySplit()));
