...
public class SortExpressionContext
{
    ...
    private final Set<Expression> searchExpressions;

    public SortExpressionContext(Expression sortExpression, Set<Expression> searchExpressions)
    {
        this.sortExpression = requireNonNull(sortExpression, "sortExpression can not be null");
        this.searchExpressions = ImmutableSet.copyOf(searchExpressions);
    }
