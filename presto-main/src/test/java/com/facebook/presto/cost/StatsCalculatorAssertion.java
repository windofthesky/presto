...
public class StatsCalculatorAssertion
{
    ...
    public StatsCalculatorAssertion check(Consumer<PlanNodeStatisticsAssertion> statisticsAssertionConsumer)
    {
        PlanNodeStatsEstimate statsEstimate = statsCalculator.calculateStats(planNode, mockLookup(), session, types);
        statisticsAssertionConsumer.accept(PlanNodeStatisticsAssertion.assertThat(statsEstimate));
        return this;
    }
