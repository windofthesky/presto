...
public class PlanOptimizers
{
    ...
    public PlanOptimizers(Metadata metadata, SqlParser sqlParser, FeaturesConfig featuresConfig, boolean forceSingleNode, MBeanExporter exporter)
    {
        ...
        builder.add(new RemoveUnsupportedDynamicFilters()); // must be fired after all iterations of ApplyDynamicFilters. Otherwise it may remove dynamic filters too early (before fully pushed down)
