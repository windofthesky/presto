...
import static com.facebook.presto.sql.planner.optimizations.EliminateCrossJoins.createJoinsReplacement;
        ...
        implements Rule
{
    ...
    public Optional<PlanNode> apply(PlanNode node, Lookup lookup, PlanNodeIdAllocator idAllocator, SymbolAllocator symbolAllocator, Session session)
    {
        ...
        PlanNode replacement = createJoinsReplacement(node, joinGraph, joinOrder, idAllocator);
