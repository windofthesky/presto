        ...
        implements Closeable
{
    ...
    public DynamicFilterClient(JsonCodec<DynamicFilterSummary> summaryJsonCodec, URI coordinatorURI, HttpClient httpClient, TaskId taskId, String source, int expectedDriversCount)
    {
