...
public class SimplePlanNodeStatsEstimateMath
{
    private SimplePlanNodeStatsEstimateMath()
    {}
    ...
    private static PlanNodeStatsEstimate subtractStatsWithRangeStrategy(PlanNodeStatsEstimate left, PlanNodeStatsEstimate right, SubtractRangeStrategy strategy)
    {
    ...
    {
        return subtractStatsWithRangeStrategy(left, right, StatisticRange::subtract);
    }

    public static PlanNodeStatsEstimate subtractNonRangeStats(PlanNodeStatsEstimate left, PlanNodeStatsEstimate right)
    {
        return subtractStatsWithRangeStrategy(left, right, ((leftRange, rightRange) -> leftRange));
    }
    ...
    private static SymbolStatsEstimate addColumnStats(SymbolStatsEstimate leftStats, double leftRows, SymbolStatsEstimate rightStats, double rightRows, double newRowCount)
    {
        ...
        return SymbolStatsEstimate.builder()
                .setDistinctValuesCount(sum.getDistinctValuesCount())
                .setHighValue(sum.getHigh())
                .setLowValue(sum.getLow())
