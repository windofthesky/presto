...
public class PlanNodeStatsSummarizer
{
    ...
    public static Map<PlanNodeId, PlanNodeStats> aggregatePlanNodeStats(StageInfo stageInfo, boolean verbose)
    {
        ...
        List<PlanNodeStats> planNodeStats = stageInfo.getTasks().stream()
                ...
                .flatMap(taskStats -> getPlanNodeStats(taskStats, verbose).stream())
                .collect(toList());
    ...
    private static List<PlanNodeStats> getPlanNodeStats(TaskStats taskStats, boolean verbose)
    {
        ...
        for (PipelineStats pipelineStats : taskStats.getPipelines()) {
            ...
            for (OperatorStats operatorStats : pipelineStats.getOperatorSummaries()) {
                ...
                if (operatorStats.getInfo() instanceof WindowOperator.WindowInfo && verbose) {
                    WindowOperator.WindowInfo windowInfo = (WindowOperator.WindowInfo) operatorStats.getInfo();
