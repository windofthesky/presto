...
public class SimplifiedHistogramStats
{
    ...
    public ColumnStatistics toColumnStatistics()
    {
    ...
    public static SimplifiedHistogramStats of(ColumnStatistics columnStatistics, TypeStatOperatorCaller operatorCaller)
    {
        RangeColumnStatistics stats = columnStatistics.getOnlyRangeColumnStatistics();
        SimplifiedHistogramStats newStats = new SimplifiedHistogramStats(
                ...
                stats.getDataSize(),
                columnStatistics.getNullsFraction(),
