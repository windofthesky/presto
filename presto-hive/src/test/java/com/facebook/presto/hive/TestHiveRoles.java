        ...
        extends AbstractTestQueryFramework
{
    ...
    private MaterializedResult applicableRoles(String... values)
    {
        ...
        MaterializedResult.Builder result = MaterializedResult.resultBuilder(queryRunner.getDefaultSession(), types);
        Object[] row = null;
    ...
    {
        return queryRunner.execute(createAdminSession(), sql);
    }

    private MaterializedResult executeFromUser(String user, String sql)
    {
        return queryRunner.execute(createUserSession(user), sql);
    }
