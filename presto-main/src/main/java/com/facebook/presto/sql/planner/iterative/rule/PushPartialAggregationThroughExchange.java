        ...
        implements Rule
{
    ...
    private PlanNode pushPartial(AggregationNode partial, ExchangeNode exchange, Context context)
    {
        ...
        for (int i = 0; i < exchange.getSources().size(); i++) {
            ...
            AggregationNode mappedPartial = symbolMapper.map(partial, source, context.getIdAllocator());
