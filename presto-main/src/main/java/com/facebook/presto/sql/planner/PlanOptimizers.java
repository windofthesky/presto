...
public class PlanOptimizers
{
    ...
    @Inject
    public PlanOptimizers(Metadata metadata, SqlParser sqlParser, FeaturesConfig featuresConfig, MBeanExporter exporter, CostCalculator costCalculator, GlobalProperties globalProperties, InternalNodeManager nodeManager)
    {
        this(metadata, sqlParser, featuresConfig, false, exporter, costCalculator, globalProperties, nodeManager.getNodes(NodeState.ACTIVE).size());
    }
    ...
    public PlanOptimizers(Metadata metadata, SqlParser sqlParser, FeaturesConfig featuresConfig, boolean forceSingleNode, MBeanExporter exporter, CostCalculator costCalculator, GlobalProperties globalProperties, int nodeCount)
    {
