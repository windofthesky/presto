        ...
        implements Operator
{
            ...
            implements OperatorFactory
    {
        ...
        private final Optional<DynamicFilterClientSupplier> dynamicFilterClientSupplier;
        ...
        public DynamicFilterSourceOperatorFactory(
                ...
                Optional<DynamicFilterClientSupplier> dynamicFilterClientSupplier,
                String sourceId,
                int expectedDrivers)
        {
        ...
        public Operator createOperator(DriverContext driverContext)
        {
            ...
            return new DynamicFilterSourceOperator(operatorContext,
                    ...
                    dynamicFilterClientSupplier.map(supplier -> supplier.get(driverContext.getPipelineContext().getTaskId(), sourceId, expectedDrivers)));
        }
    ...
    private final List<Integer> filterChannels;
    private final List<String> filterDynamicFilterNames;
    private final Optional<DynamicFilterClient> client;
    ...
    public DynamicFilterSourceOperator(
            ...
            List<Integer> filterChannels,
            List<String> filterDynamicFilterNames,
            Optional<DynamicFilterClient> client)
    {
    ...
    private void sendTupleDomain()
    {
        // we don't want to filter if there're too many values
        if (positionCount > positionsLimit) {
            client.ifPresent(client -> client.storeSummary(new DynamicFilterSummary(TupleDomain.all())));
            return;
        }
        ...
        client.ifPresent(client -> client.storeSummary(new DynamicFilterSummary(TupleDomain.withColumnDomains(domainsBuilder.build()))));
    }
}
