...
public class DynamicFilterResource
{
    ...
    @PUT
    @Path("/{stageId}/{taskId}/{expectedCount}")
    ...
    {
        service.storeOrMergeSummary(queryId, source, stageId, taskId, dynamicFilterSummary, expectedCount);
    ...
    public Response getSummary(
            ...
            @PathParam("source") String source)
    {
        Optional<DynamicFilterSummary> summary = service.getSummary(queryId, source);
