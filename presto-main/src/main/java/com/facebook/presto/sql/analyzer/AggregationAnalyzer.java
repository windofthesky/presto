...
import static com.facebook.presto.sql.analyzer.ScopeReferenceExtractor.isFieldFromRelation;
            ...
            extends AstVisitor<Boolean, Void>
    {
        ...
        protected Boolean visitSubqueryExpression(SubqueryExpression node, Void context)
        {
            ...
            return getReferencesToScope(node, analysis, sourceScope)
                    .allMatch(this::analyzeSubqueryReferenceToSourceScope);
        }

        private boolean analyzeSubqueryReferenceToSourceScope(Expression referenceExpression)
        {
