        ...
        extends AbstractType
{
    ...
    public long hash(Block block, int position)
    {
        ...
        for (int i = 0; i < array.getPositionCount(); i++) {
            hash = getHash(hash, hashPosition(elementType, array, i));
        }
        return hash;
    }
