        ...
        implements PlanOptimizer
{
    ...
    public DetermineJoinDistributionType(StatsCalculator statsCalculator, CostCalculator costCalculator, GlobalProperties globalProperties, int nodeCount)
    {
    ...
    public PlanNode optimize(PlanNode plan, Session session, Map<Symbol, Type> types, SymbolAllocator symbolAllocator, PlanNodeIdAllocator idAllocator)
    {
        ...
        return SimplePlanRewriter.rewriteWith(new Rewriter(session, globalProperties, statsCalculator, costCalculator, types, nodeCount), plan);
    }
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        public Rewriter(Session session, GlobalProperties globalProperties, StatsCalculator statsCalculator, CostCalculator costCalculator, Map<Symbol, Type> types, int nodeCount)
        {
        ...
        {
            Estimate dataSize = lookup.getStats(session, types, node).getOutputSizeInBytes();
            if (!dataSize.isValueUnknown()) {
                return dataSize;
            }

            dataSize = lookup.getStats(session, types, node).getOutputRowCount();
            if (!dataSize.isValueUnknown()) {
