...
public class TestDetermineJoinDistributionType
{
    ...
    {
        this.queryRunner = LocalQueryRunner.queryRunnerWithFakeNodeCountForStats(testSessionBuilder()
                .setCatalog("local")
                .setSchema("sf10")
                .build(), 4);
    ...
    private void assertPlan(Session session, @Language("SQL") String sql, PlanMatchPattern pattern)
    {
        List<PlanOptimizer> optimizers = ImmutableList.of(
                ...
                new DetermineJoinDistributionType(queryRunner.getStatsCalculator(), new GlobalProperties(), 4));
