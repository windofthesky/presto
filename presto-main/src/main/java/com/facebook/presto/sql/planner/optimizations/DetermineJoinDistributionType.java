        ...
        implements PlanOptimizer
{
            ...
            extends SimplePlanRewriter<Void>
    {
        ...
        {
            Estimate dataSize = statsCalculator.calculateStats(node, noLookup(), session, types).getOutputSizeInBytes();
            if (!dataSize.isValueUnknown()) {
                return dataSize;
            }

            dataSize = statsCalculator.calculateStats(node, noLookup(), session, types).getOutputRowCount();
            if (!dataSize.isValueUnknown()) {
