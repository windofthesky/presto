...
public class TestJoinStatsRule
{
            ...
            throws Exception
    {
        ...
        PlanNodeStatsEstimate innerJoinStats = planNodeStats(innerJoinRowCount,
                symbolStatistics(LEFT_JOIN_COLUMN, 0.0, 10.0, 0.0, RIGHT_JOIN_COLUMN_NDV),
    ...
    private static PlanNodeStatsEstimate planNodeStats(double rowCount, SymbolStatistics... symbolStatistics)
    {
        ...
        for (SymbolStatistics symbolStatistic : symbolStatistics) {
            builder.addSymbolStatistics(symbolStatistic.symbol, symbolStatistic.symbolStatsEstimate);
        }
    ...
    {
        final Symbol symbol;
        final SymbolStatsEstimate symbolStatsEstimate;

        SymbolStatistics(Symbol symbol, SymbolStatsEstimate symbolStatsEstimate)
        {
            this.symbol = symbol;
            this.symbolStatsEstimate = symbolStatsEstimate;
        }
    }
}
