...
public class TestCacheMetadata
{
    ...
    public void setUp()
    {
        metadata = new CacheMetadata(new TestingNodeManager(), new CacheConnectorId("test"));
    }
    ...
    public void testActiveTableIds()
    {
        ...
        CacheTableHandle firstTableHandle = (CacheTableHandle) metadata.getTableHandle(SESSION, firstTableName);
        ...
        CacheTableHandle secondTableHandle = (CacheTableHandle) metadata.getTableHandle(SESSION, secondTableName);
