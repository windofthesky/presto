...
is set up for high availability. For these and other properties, see the :doc:`/connector/hive`.

For detailed documentation on ``catalog add``, see :ref:`catalog-add`.
For more on which catalogs Presto supports, see the :doc:`/connector`.
