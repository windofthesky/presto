        ...
        extends AbstractTestFunctions
{
    ...
    public void testCoercion()
            throws Exception
    {
        assertFunction("apply(90, x -> x + DOUBLE '9.0')", DOUBLE, 99.0);

        assertFunction("apply(90, \"$internal$bind\"(DOUBLE '9.0', (x, y) -> x + y))", DOUBLE, 99.0);
        assertFunction("invoke(\"$internal$bind\"(8, x -> x + DOUBLE '1.0'))", DOUBLE, 9.0);
    }
