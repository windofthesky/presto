        ...
        extends Expression
{
    ...
    public LocalLimit(long count, Expression argument)
    {
    ...
    public Expression copyWithArguments(List<Expression> arguments)
    {
        ...
        return new LocalLimit(count, arguments.get(0));
    }

    @Override
    public String toString()
    {
        return String.format("(local-limit %s %s)", count, getArguments().get(0));
    }

    @Override
    protected boolean shallowEquals(Expression other)
    {
        LocalLimit that = (LocalLimit) other;
