...
import com.facebook.presto.operator.spiller.TestingOperatorSpillContext;
...
public class TestBinaryFileSpiller
{
    ...
    public void testFileSpiller()
            throws Exception
    {
        try (Spiller spiller = factory.create(TYPES, () -> new LocalSpillContext(new TestingOperatorSpillContext()), memoryContext)) {
