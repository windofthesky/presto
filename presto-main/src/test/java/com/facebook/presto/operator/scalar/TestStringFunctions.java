        ...
        extends AbstractTestFunctions
{
    ...
    public void testCharSubstring()
    {
        ...
        assertFunction("SUBSTR(CAST('No service location in ' AS CHAR(23)), 1, 20)", createCharType(23), padRight("No service location", 23));
    ...
    public void testRightTrimParametrized()
    {
        ...
        assertFunction("RTRIM(CAST('No service location in' AS CHAR(22)), 'in')", createCharType(22), padRight("No service location", 22));
    ...
    public void testCharTrimParametrized()
    {
        ...
        assertFunction("TRIM(CAST('No service location in' AS CHAR(22)), 'in')", createCharType(22), padRight("No service location", 22));
