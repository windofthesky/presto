        ...
        implements PlanOptimizer
{
    ...
    public static PlanNode createJoinsReplacement(PlanNode node, JoinGraph graph, List<Integer> joinOrder, PlanNodeIdAllocator idAllocator)
    {
        ...
        checkArgument(Objects.equals(node.getId(), graph.getRootId()), "graph is not rooted at node");
            ...
            extends SimplePlanRewriter<PlanNode>
    {
        ...
        public PlanNode visitPlan(PlanNode node, RewriteContext<PlanNode> context)
        {
            ...
            return createJoinsReplacement(node, graph, joinOrder, idAllocator);
        }
    }
}
